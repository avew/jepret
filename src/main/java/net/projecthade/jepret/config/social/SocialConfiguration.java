package net.projecthade.jepret.config.social;

import net.projecthade.jepret.repository.SocialUserConnectionRepository;
import net.projecthade.jepret.repository.CustomSocialUsersConnectionRepository;
import net.projecthade.jepret.security.social.CustomSignInAdapter;
