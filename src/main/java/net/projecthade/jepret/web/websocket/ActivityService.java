package net.projecthade.jepret.web.websocket;

import net.projecthade.jepret.security.SecurityUtils;
import net.projecthade.jepret.web.websocket.dto.ActivityDTO;
...
import static net.projecthade.jepret.config.WebsocketConfiguration.IP_ADDRESS;
