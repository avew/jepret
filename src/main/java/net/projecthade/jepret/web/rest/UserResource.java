...
import net.projecthade.jepret.repository.AuthorityRepository;
import net.projecthade.jepret.repository.UserRepository;
import net.projecthade.jepret.security.AuthoritiesConstants;
import net.projecthade.jepret.service.MailService;
import net.projecthade.jepret.service.UserService;
import net.projecthade.jepret.web.rest.dto.ManagedUserDTO;
